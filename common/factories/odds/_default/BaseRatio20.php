 ...
 */
class BaseRatio20 extends BaseRatio implements iRatio
{
    /**
     * @return int
     */
    public function check()
    {
        ...
        $msg .= \CHtml::tag('li', [], sprintf('Операция: %s == 2 && %s == 0 = %s',
            $this->getEvent()->getResult()->getTeam1Result(),
            $this->getEvent()->getResult()->getTeam2Result(),
            $this->getEvent()->getResult()->getTeam1Result() == 2 && $this->getEvent()->getResult()->getTeam2Result() == 0 ? 'TRUE' : 'FALSE'
        ));

        if($this->getEvent()->getResult()->getTeam1Result() == 2 && $this->getEvent()->getResult()->getTeam2Result() == 0) {
